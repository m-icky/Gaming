          ...
          <div class="container" >
               <div class="row">
                    ...
                    <div class="col-6 .col-md-4">
                        <h2 class="mx-auto" style="width: 600px;" data-aos="fade-up" data-aos-delay="200">Website Manager Registration</h2>

                        <form method="post" action="web_man_act.php" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
                            ...
                            <input type="tel" class="form-control" name="phone" pattern="[0-9]{10}" required placeholder="Phone" required>
