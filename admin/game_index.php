...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
     ...
     <section class="hero d-flex flex-column justify-content-center align-items-center" id="home">
        ...
        <p class="date">price $500</p>
        <p class="description">2048 is a single-player sliding tile puzzle video game written by Italian web developer Gabriele Cirulli and published on GitHub.</p>
        <p><button>
      ...
      <div class="card card-two">
        <h2 class="card-title">A Dark Room</h2>
