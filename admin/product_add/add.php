          ...
          <div class="container" >
               <div class="row">
                    ...
                    <div class="col-6 .col-md-4">
                        <h2 class="mx-auto" style="width: 600px;" data-aos="fade-up" data-aos-delay="200">Product Details</Details></h2>

                        <form method="post" action="add_act.php" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
