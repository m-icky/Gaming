                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h6 data-aos="fade-up" data-aos-delay="300">The strength we need is all around us</h6>

                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500"> Behind every screen there is someone controlling you</h1>

                                    <a href="#feature" class="btn custom-btn mt-3" data-aos="fade-up" data-aos-delay="300">Get started</a>
