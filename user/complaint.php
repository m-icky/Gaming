        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="social-icon ml-lg-3">
                    <li><a href="complaints.php" class="fa fa-facebook"></a></li>
                    <li><a href="complaints.php" class="fa fa-twitter"></a></li>
                    <li><a href="complaints.php" class="fa fa-instagram"></a></li>
                </ul>
            </div>
          ...
          <div class="container" >
               <div class="row">
                    ...
                    <div class="col-6 .col-md-4">
                        <h2 class="mx-auto" style="width: 600px;" data-aos="fade-up" data-aos-delay="200">Complaint Box</h2>

                        <form method="post" action="complaint_act.php" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
                            <input type="text" class="form-control" name="name" placeholder="Name">

                            <textarea class="form-control" rows="5" name="complaint" placeholder="Complaints"></textarea>
