...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
     ...
     <div class="container add-emp">		
			<center><h1 class="p-2 mb-0 bg-info text-dark"><strong>Product Return Details</strong></h1><br></center>
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					<tr>			
						...
						<th class="p-3 mb-2 bg-warning text-light">Return</th>
					</tr>
					<?php
						include '../connection.php';
                        $id=$_SESSION['loginid'];
						$sql = "SELECT * from product_book WHERE product_book.loginid = '$id'  AND status='Delivered'";
              ...
              <td><a class="btn btn-danger py-2 px-3"  href="po_return_act.php?id=<?php echo $data['id']; ?>">Return</a> </td>
						</tr> 
					<?php    
						}
					?>
			...
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					...
					<?php
						include '../connection.php';
                        $id=$_SESSION['loginid'];
						$sql = "SELECT * from game_book WHERE game_book.loginid = '$id' AND status='Delivered' ";
						$result = mysqli_query($con, $sql);           
						while ($data = mysqli_fetch_assoc($result))			 
						{
					?>      <td><?php echo $data['cname'];?></td>
              ...
              <!-- <td><a class="btn btn-primary py-2 px-3" href="update_btn.php?id=<?php echo $data['id']; ?>">Update</a> </td> -->
              <td><a class="btn btn-danger py-2 px-3"  href="ga_return_act.php?id=<?php echo $data['id']; ?>">Return</a> </td>
						</tr> 
					<?php    
						}
					?>
