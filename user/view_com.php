...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
     ...
     <div class="container add-emp">		
			<center><h1 class="p-2 mb-0 bg-info text-dark"><strong>complaint Details</strong></h1><br></center>
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					<tr>			
						<th class="p-3 mb-2 bg-warning text-light">Name </th>
						<th class="p-3 mb-2 bg-success text-light">Reply</th>
					...
					<?php
                        ...
                        $id=$_SESSION['loginid'];
						$sql = "select * from complaint_reply ";
