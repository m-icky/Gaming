          ...
          <div class="container" >
               <div class="row">
                    <div class="col-6 .col-md-4">
                        ...
                        <form method="post" action="game_book_act.php" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
                        <?php
                                      include('../connection.php');
                                      $id=$_SESSION['loginid'];
                                      $proid=$_GET['id'];
                                      $sql="SELECT * FROM `game_details` WHERE id='$proid'";
                            ...
                            <input type="text" class="form-control" name="name" value="<?php echo $row['name'];?>" placeholder="Name" readonly>
                            <label>Total Amount</label>
                            <input type="text" class="form-control" name="price"  value="<?php echo $row['price'];?>" placeholder="Price" readonly>
                            <label>Description</label>
                            <input type="text" class="form-control" name="description"  value="<?php echo $row['description'];?>" placeholder="Description" readonly>
