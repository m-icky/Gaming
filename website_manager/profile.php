       ...
       <table class="table table-bordered table-hover">
           <!-- <thead class="thead-dark"> -->
               <tr>			
                   ...
                   <th class="p-3 mb-2 bg-primary text-light">Phone Number</th>
               ...
               <?php
                   ...
                   $sql = "select * from `website_manager`";
         ...
         <td><a class="btn btn-success py-2 px-3" href="update_profile.php?id=<?php echo $data['id']; ?>">Update</a> </td>
