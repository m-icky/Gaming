			...
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					...
					<?php
						...
						$sql = "SELECT * from product_book WHERE status='Booked' OR status='Delivered' OR status='Packed' OR status='Confirmed' OR status='Wait For Confirmation'";
...
<div class="container add-emp">		
			...
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					...
					<?php
						include '../connection.php';
						$sql = "SELECT * from game_book WHERE status='Booked' OR status='Delivered' OR status='Packed' OR status='Confirmed' OR status='Wait For Confirmation'";
						$result = mysqli_query($con, $sql);           
						while ($data = mysqli_fetch_assoc($result))			 
						{
					?>      <td><?php echo $data['cname'];?></td>
