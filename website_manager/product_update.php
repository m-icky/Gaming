          ...
          <div class="container" >
               <div class="row">
                    ...
                    <div class="col-6 .col-md-4">
                        ...
                        <form method="post" action="pro_up_act.php?saveid=<?php echo $_REQUEST['id']?>" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
                        <?php
                                      include('../connection.php');
                                      $proid=$_GET['id'];
                                      $sql="SELECT * FROM `product_book` WHERE id='$proid'";
