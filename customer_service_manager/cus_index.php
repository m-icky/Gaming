...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="cus_index.php">Gaming <p>welcome Customer Website Manager</p></a>
    ...
    <div class="card">
      ...
      <div class="card-text">
        <h2>  <a href="view_com.php">Complaints </a></h2>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-text card2">
        <h2>  <a href="view_feed.php">Feedback </a></h2>
      </div>
    </div>
